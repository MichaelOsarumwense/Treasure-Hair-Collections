...
3. Created a .gitignore file and I have added the files and folders that won't need to push to GitHub (i.e. '_. sqlite3','env.py','.vscode/','.venv/', pycache, _.pyc)
...
| STRIPE_WH_SECRET      | <your_stripe\_\_wh_secret>   |
